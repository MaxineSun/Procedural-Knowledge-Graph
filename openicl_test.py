...
def main(args):
    ...
    if args.case == "bi-class":
        ...
        if args.dataset == "dbpedia_14":
            data = DatasetReader('dbpedia_14', input_columns=['content'], output_column='label', ds_size=128)
            template = PromptTemplate(template={
                                                    0: '</E>Content about Company: </content>',
                                                    1: '</E>Content about Educational Institution: </content>',
                                                    2: '</E>Content about Artist: </content>',
                                                    3: '</E>Content about Athlete: </content>',
                                                    4: '</E>Content about Office Holder: </content>',
                                                    5: '</E>Content about Mean Of Transportation: </content>',
                                                    6: '</E>Content about Building: </content>',
                                                    7: '</E>Content about Natural Place: </content>',
                                                    8: '</E>Content about Village: </content>',
                                                    9: '</E>Content about Animal: </content>',
                                                    10: '</E>Content about Plant: </content>',
                                                    11: '</E>Content about Album: </content>',
                                                    12: '</E>Content about Film: </content>',
                                                    13: '</E>Content about Written Work: </content>'
                                            },
