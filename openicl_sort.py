...
def main(args):
    ...
    data = DatasetReader('gpt3mix/sst2', input_columns=['text'], output_column='label', ds_size=10)
    ...
    # TopK Retriever
    retriever = RandomRetriever(data, ice_num=8, index_split='train', test_split='test', seed=2)
    # Define a Inferencer
